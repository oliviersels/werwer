...
class PlayerAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (_('Personal info'), {'fields': ('first_name', 'last_name', 'dcinumber', 'is_judge')}),
    ...
    def get_fieldsets(self, request, obj=None):
        ...
        return super(PlayerAdmin, self).get_fieldsets(request, obj)
    ...
    def get_form(self, request, obj=None, **kwargs):
        ...
        return super(PlayerAdmin, self).get_form(request, obj, **defaults)
    ...
    def get_urls(self):
        ...
        ) + super(PlayerAdmin, self).get_urls()

    def lookup_allowed(self, lookup, value):
        # See #20078: we don't want to allow any lookups involving passwords.
        if lookup.startswith('password'):
            return False
        return super(PlayerAdmin, self).lookup_allowed(lookup, value)
    ...
    def add_view(self, request, form_url='', extra_context=None):
        ...
        return super(PlayerAdmin, self).add_view(request, form_url,
                                               extra_context)
    ...
    def response_add(self, request, obj, post_url_continue=None):
        ...
        return super(PlayerAdmin, self).response_add(request, obj,
                                                   post_url_continue)
